...
| 7 |[link to fifth OpenStreetMap contribution](https://www.openstreetmap.org/edit?editor=id&changeset=82226214#map=19/40.71234/-74.01526) | OpenStreetMap feature |A new and rather small ice skating rink that recently opened a few years ago within the Brookfield Mall wasn't yet marked within the OpenStreetMap system so I decided to add a new point ice skating point icon for it and inputted other important information such as its address.|
